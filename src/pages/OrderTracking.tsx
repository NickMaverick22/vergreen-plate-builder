  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-vergreen-50 to-emerald-50 pb-20">
      ...
      <div className="max-w-md mx-auto p-4 space-y-6">
        ...
        {/* Pickup Code */}
        <Card className="bg-gradient-to-r from-vergreen-500 to-vergreen-600 rounded-3xl p-6 text-white text-center">
        ...
        <div className="space-y-3">
          <Button
            ...
            variant="outline"
            className="w-full border-vergreen-200 text-vergreen-700 hover:bg-vergreen-50 rounded-2xl py-3"
          >
            View Order History
          </Button>
          <Button
